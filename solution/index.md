...
{{< figure src="nsis_01.png" title="파일교체 스크립트 예제" >}}
{{< figure src="nsis_02.png" title="파일교체 스크립트 설명" >}}
...
{{< figure src="patch-sw-logic.png" title="패치 내부구조" >}}
...
{{< figure src="patch-sw-logic-exe.png" title="배포파일 내부 비교" >}}
...
{{< figure src="os-info.png" title="64bit Windows 환경 정보" >}}
...
{{< figure src="32bit-application.png" title="작업관리자로 32bit application 확인" >}}
...
{{< figure src="redistributable.png" title="재배포 가능 패키지 설치가 필요하다" >}}
...
{{< figure src="patch-sw-process.png" title="클라이언트 패치 흐름도 예시" >}}
